...
calib3d = {'': ['findHomography', 'calibrateCameraExtended', 'drawFrameAxes', 'estimateAffine2D', 'getDefaultNewCameraMatrix', 'initUndistortRectifyMap', 'Rodrigues', 'checkChessboard', 'findChessboardCorners', 'findChessboardCornersSB', 'drawChessboardCorners', 'getOptimalNewCameraMatrix', 'cornerSubPix', 'find4QuadCornerSubpix']}
